						...
						?>
							<li class="dropdown dropdown-brand hidden-xs">
								<a class="dropdown-toggle brand-title" data-toggle="dropdown" data-hover="dropdown" href="#">
									<span id="brand-desktop" class="brand-name logotype" style="font-size: 18px;"><?php global $wgLiquiFlowAlphawiki; echo (isset($wgLiquiFlowAlphawiki) && $wgLiquiFlowAlphawiki)?'<small>' . wfMessage( 'liquiflow-brand' )->text() . '</small> alpha':wfMessage( 'liquiflow-brand' )->inContentLanguage()->parse(); ?></span> <span class="caret"></span> <br>
...
<nav id="mobile-search-bar" class="navbar visible-xs noprint hidden">
	<form action="<?php $this->text( 'wgScript' ) ?>" id="mobile-search-form" class="navbar-form navbar-left" role="search">
		<div class="input-group">
			<input id="searchInput-mobile" type="search" accesskey="f" title="Search <?php echo wfMessage( 'liquiflow-brand' )->inContentLanguage()->parse() . ' ' . $wgLiquiFlowWikiTitle; ?> Wiki [alt-shift-f]" placeholder="Search <?php echo $this->msg( 'liquiflow-brand' ); ?>" name="search" autocomplete="off" class="form-control">
						...
						<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform" class="navbar-form" role="search">
							<div class="input-group">
								<input id="searchInput" type="search" accesskey="<?php $this->msg( 'accesskey-search' ); ?>"
									title="<?php $this->msg( 'liquiflow-search' ) . ' ' . $this->msg( 'liquiflow-brand' ) . ' ' . $wgLiquiFlowWikiTitle;?> Wiki [alt-shift-<?php $this->msg( 'accesskey-search' ); ?>]" placeholder="<?php $this->msg( 'liquiflow-search-placeholder' ); ?>"
